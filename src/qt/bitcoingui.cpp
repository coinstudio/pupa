...
{
    resize(710, 540);
    setWindowTitle(tr("PupaCoin Core") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/PupaCoin"));
    setWindowIcon(QIcon(":icons/PupaCoin"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/PupaCoin"), tr("&About PupaCoin"), this);
    ...
    toggleHideAction = new QAction(QIcon(":/icons/PupaCoin"), tr("&Show / Hide"), this);
...
#ifndef Q_OS_MAC
            qApp->setWindowIcon(QIcon(":icons/PupaCoin_testnet"));
            setWindowIcon(QIcon(":icons/PupaCoin_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/PupaCoin_testnet"));
#endif
            if(trayIcon)
            {
